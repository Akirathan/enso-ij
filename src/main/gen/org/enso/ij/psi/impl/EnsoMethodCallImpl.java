...
public class EnsoMethodCallImpl extends ASTWrapperPsiElement implements EnsoMethodCall {

  public EnsoMethodCallImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<EnsoCallArgument> getCallArgumentList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, EnsoCallArgument.class);
  }
