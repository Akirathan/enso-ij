...
public class EnsoTypeDefinitionImpl extends ASTWrapperPsiElement implements EnsoTypeDefinition {

  public EnsoTypeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public EnsoTypeBody getTypeBody() {
    return findNotNullChildByClass(EnsoTypeBody.class);
  }
