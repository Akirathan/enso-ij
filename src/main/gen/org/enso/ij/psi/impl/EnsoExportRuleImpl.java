...
public class EnsoExportRuleImpl extends ASTWrapperPsiElement implements EnsoExportRule {

  public EnsoExportRuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull EnsoVisitor visitor) {
    visitor.visitExportRule(this);
  }
